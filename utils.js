...
const Utils = {
    ...
    /**
     * Преобразует массив в объект, где ключи будут значениями переданого ключа **key**, а значения - массивом из элементов массива, которые соответсвуют значению по значению ключа **key**
     * @param {{}[]} arr массив из объектов
     * @param {string} key ключ для групировки
